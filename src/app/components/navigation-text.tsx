...
export default function NavigationText({ steps }: props) {
  ...
  return (
    <div className="absolute bottom-0 left-0 w-full bg-white border-t border-gray-200 z-50 shadow-lg">
      ...
      {nextSteps.length > 0 && (
        <div className="px-6 py-3 max-h-56 overflow-y-auto bg-gray-50/50">
