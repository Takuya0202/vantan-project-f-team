...
export default function GeoModal({ setIsOpen, time, arrivalTime, distance }: GeoModalProps) {
  return (
    <div className="bg-blue-200 rounded-2xl z-50 bottom-0 left-0 w-full h-[150px] fixed">
      ...
      <div className="flex justify-between items-center">
        <div className="ml-[26px]">
          <p className="text-[18px] font-sans font-regular">{time}分</p>
          <p className="text-[14px] font-sans font-regular">{arrivalTime}に到着</p>
          <p className="text-[14px] font-sans font-regular">{distance}km</p>
        </div>
